$(function() {
    if (location.pathname.indexOf('/bai-hat/') === 0) {
        ...
        $('#tabService').replaceWith(' <a id="tabService" title="Download file - Tool Get Link From Tiện ích máy tính" href="http://htstar.design/mp3zing.php?q=128&link=' + code + '"class="button-style-1 pull-left fn-tab"><i class="zicon icon-download"  ></i><span>Tải nhạc 128 kbps </span></a> <a id="tabService" title="Download file - Tool Get Link From Tiện ích máy tính"  href="http://htstar.design/mp3zing.php?q=320&link=' + code + '" class="button-style-1 pull-left fn-tab"><i class="zicon icon-download"></i><span>Tải nhạc 320 kbps</span></a> <a id="tabService" title="Download file - Tool Get Link From Tiện ích máy tính"href="http://htstar.design/mp3zing.php?q=lossless&link=' + code + '" target="_blank" class="button-style-1 pull-left fn-tab"><i class="zicon icon-download"></i><span>Tải nhạc Lossless</span></a> ')
    }
    var linkbaihat = $("link[rel='canonical']").attr("href");
    if ($('#btnDownloadBox') === '<a href="javascript:;" id="btnDownloadBox"></span>Tải nhạc</a>') {
        $('#btnDownloadBox').replaceWith('<a title="Download file - Tool Get Link From Tiện ích máy tính" href="http://htstar.design/nctgetlink.php?q=128&link=' + linkbaihat + '"><span class="icon_download"></span>   Tải nhạc 128kbps   </a><a title="Download file - Tool Get Link From Tiện ích máy tính" href="http://htstar.design/nctgetlink.php?q=320&link=' + linkbaihat + '"></span>   Tải nhạc 320kbps   </a><a href="title="Download file - Tool Get Link From Tiện ích máy tính" http://htstar.design/nctgetlink.php?q=lossless&link=' + linkbaihat + '"></span>   Tải nhạc Lossless</a>')
    } else {
    ...
    if (location.pathname.indexOf('/file/') === 0) {
        ...
        $('.policy_download').prepend('<div class="col-xs-12"><a title="Download nhanh không giới hạn dung lượng file" style="margin-top: 10px; height: 70px;" class="btn btn-success btn-lg btn-block btn-download-sms" href="' + link1 + '">        <i class="fa fa-cloud-download fa-2x pull-left"></i>        <span class="pull-right text-right download-txt">            Tải nhanh qua GETLINKFSHARE.COM<br>            <small>Tool Get link From Tiện Ích Máy Tính </small>        </span></a></div> <div class="col-xs-12"><a title="Download nhanh tại chỗ, không cần sang sang khác " style="margin-top: 10px; height: 70px;" class="btn btn-success btn-lg btn-block btn-download-sms" href="http://bfeu.tk/getfshare.php?link=' + location.href + '">        <i class="fa fa-cloud-download fa-2x pull-left"></i>        <span class="pull-right text-right download-txt">Tải MAX nhanh File vài mb ^_^ <br><small>Tool Get link From Tiện Ích Máy Tính </small>        </span></a></div>')
    };
    if (window.location.hostname == 'javhd.com') {
        var link = window.location.href;
        var linkget = 'http://starlabs.ml/getjav.php?link=' + link;
        ...
        $('.downloads').replaceWith('<div><a class="downloads" href="' + linkget + '" title="Download file - Tool Get Link From Tiện ích máy tính" ><i>Tải về máy</i></a></div>')
    };
    if (window.location.hostname == 'tailieu.vn') {
        var link = window.location.href;
        var linkget = 'https://linksvip.net/?link=' + link;
        $('.btncam.marginright10').replaceWith('<a class="btncam marginright10" style="width:170px;margin:10px 0 0 0px;" title="Download tài liệu qua linksvip.net không cần acc vip" href="' + linkget + '"><img valign="middle" src="http://static1.tailieu.vn/b2013az/templates/version1/default/images/down16x21.png" title="Download file - Tool Get Link From Tiện ích máy tính" >Download qua linksvip' + '</a>')
    };
    if (window.location.hostname == 'hoctot123.com') {
        var link = window.location.href;
        var linkget = 'http://bfeu.tk/getlinkhoctot123/xuly.php?url=' + link;
        $('#login_pop').replaceWith('<a href="' + linkget + '" id="login_pop"><strong style="color:red" title="Download file - Tool Get Link From Tiện ích máy tính" >DOWNLOAD TÀI LIỆU ĐÃ GET - Tool Get Link   from TIMT</strong></a>')
    };
    if (window.location.hostname == '4share.vn') {
        var link = window.location.href;
        var linkget = 'https://linksvip.net/?link=' + link;
        $("a[href='/payment/card/#FUNNY']").replaceWith('<a href="' + linkget + '" ><input style="font-weight: bold; color: red" value="DOWNLOAD QUA LINKSVIP" type="button" title="Download file - Tool Get Link From Tiện ích máy tính" ></a>')
    };
    if (window.location.hostname == 'drive.google.com') {
        var link = window.location.href;
        var linkget = 'http://starlabs.ml/getdrivepdf.php?link=' + link;
        $("#one-google-bar").after('<style>h2 {color: white; font-weight: bold;text-shadow: 0 0 0 #111111, 0 0 0.5em #adffad, 0 0 0.4em #adffad;} } </style> <a title="Tải tài liệu bị khóa - Tool Get Link From Tiện ích máy tính" href="' + linkget + '"><h2>Tải văn bản bị khóa</h2></a><p style="color: white; font-weight: bold;text-shadow: 0 0 0 #111111, 0 0 0.5em red, 0 0 0.4em red;">Tool From TIMT</p>')
    }
});
